...
SKIP: {
    skip "No ec support in this OpenSSL build", 1 if disabled("ec") || disabled("ecx");
...
SKIP: {
    skip "No EC or EDWARD support in this OpenSSL build", 1 if disabled("ec") || disabled("ecx");
